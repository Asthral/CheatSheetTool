...
Forensic_payload = base64.b64decode(Forensic_base64).decode()
...
Web_payload = base64.b64decode(Web_base64).decode()
...
Pwn_payload = base64.b64decode(Pwn_base64).decode()
...
Stegano_payload = base64.b64decode(Stegano_base64).decode()
...
Reverse_payload = base64.b64decode(Reverse_base64).decode()
...
Network_payload = base64.b64decode(Network_base64).decode()
...
Crypto_payload = base64.b64decode(Crypto_base64).decode()
...
Osint_payload = base64.b64decode(Osint_base64).decode()
...
Other_payload = base64.b64decode(Other_base64).decode()
...
Exit_payload = base64.b64decode(Exit_base64).decode()
# ============== PAYLOAD ============== #
